...
local function gui_get(player_index)
  return Globals.get_ui_state(player_index).UiCharacterInventory
end

local function gui_set(player_index, value)
  Globals.get_ui_state(player_index).UiCharacterInventory = value
end
...
Globals.register_metaclass("CharInv", { __index = CharInv } )
